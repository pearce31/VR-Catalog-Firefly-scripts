...
(function () {
    ...
    const VERT_SCALE_2D        = 1.0;   // geometrically correct (was 1.11 = 11% too tall)
    const VERT_SCALE_HALF_SBS  = 0.55;  // slight bump from 0.5 to correct minor squish
    const VERT_SCALE_OU        = 2.0;   // correct
    const VERT_SCALE_FULLSBS   = 1.1;   // slight bump from 1.0 to correct minor squish
    // ============
